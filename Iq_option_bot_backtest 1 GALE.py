...
for par in pares_abertos:
    ...
    total_entrada = win +gale1+loss
    wins = win+gale1
    assertividade = round(wins/(total_entrada)*100,2)
    resultado.append([par] +[win]+[gale1] + [doji] +[loss]+ [assertividade])

print(tabulate(resultado, headers=['PAR','WINS','GALE1','DOJI','LOSS','ASSERTIVIDADE']))